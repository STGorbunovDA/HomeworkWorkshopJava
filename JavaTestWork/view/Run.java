package Gorbunov.view;

import Gorbunov.controller.BuyerCSVHandler;
import Gorbunov.controller.ToyCSVHandler;

public class Run {
    final String FILE_NAME_TOYS = "./src/main/java/Gorbunov/db/toys.csv";
    final String FILE_NAME_BUYERS = "./src/main/java/Gorbunov/db/buyers.csv";
    final String PRIZE_TOY = "./src/main/java/com/Gorbunov/db/PrizeToyList.csv";
    final String AWARDED_TOY = "./src/main/java/com/Gorbunov/db/AwardedToyFromByuers.csv";
        ...
        do {
            ...
            switch (numberOfMenu) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    ToyCSVHandler.addRandomToyToPrizeFile(FILE_NAME_TOYS, PRIZE_TOY);
                    System.out.println("\n\tСписок призовых игрушек.");
                    System.out.println(ToyCSVHandler.readPrizeFile(PRIZE_TOY));
                    break;
                case 4:
                    ToyCSVHandler.addRandomPrizeToAwardedFileAndDeleteAwardedPrize(PRIZE_TOY, AWARDED_TOY);
                    break;
                case 5:
                    break;
                default:
