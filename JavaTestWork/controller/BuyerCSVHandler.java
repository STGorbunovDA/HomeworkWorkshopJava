...
public class BuyerCSVHandler {
    ...
    private static final String FILE_NAME_BUYERS = "./src/main/java/Gorbunov/db/buyers.csv";
    ...
    private static void appendToFileLineBuyer(List<Buyer> buyers, FileWriter writer) throws IOException {
        appendLineBuyers(buyers, writer, ToyCSVHandler.CSV_SEPARATOR);
